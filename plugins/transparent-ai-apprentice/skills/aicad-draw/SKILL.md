...
python plugins/transparent-ai-apprentice/integrations/aicad-agent-v1/plugin/aicad-agent/scripts/aicad_agent.py generate --request "120x80 plate with centered diameter 20 hole" --out build/job
python plugins/transparent-ai-apprentice/integrations/aicad-agent-v1/plugin/aicad-agent/scripts/aicad_agent.py generate --request-file request-utf8.txt --out build/job
python plugins/transparent-ai-apprentice/integrations/aicad-agent-v1/plugin/aicad-agent/scripts/aicad_agent.py validate --plan drawing.plan.json
python plugins/transparent-ai-apprentice/integrations/aicad-agent-v1/plugin/aicad-agent/scripts/aicad_agent.py compile --plan drawing.plan.json --out build/job
```
