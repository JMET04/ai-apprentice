...
All notable changes to MingTu AI are documented here.

## 1.0.0 - 2026-07-12

### Added

- Branded the product as MingTu AI with a Chinese-first plugin surface.
...
- Added the responsive MingTu mask workbench with five annotation tools, history, drafts, playback, touch support, and structured exports.
- Expanded the mask workbench into text, image, and engineering surgical correction with change/protect/reference regions, outside-mask preservation, and a separate full-regeneration choice.
...
- Multimodal mask workbench browser: 12 checks.
- Surgical Office text editing: 12 checks.
- Learned rule conflict resolution: 7 checks.
- AICAD: 6 integration checks, 10 adapter checks, and 87 manifest hashes.
